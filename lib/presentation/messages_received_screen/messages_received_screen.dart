...
class MessagesReceivedScreen extends GetWidget<MessagesReceivedController> {
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          alignment: Alignment.centerLeft,
                          child: CommonImageView(
                            svgPath: ImageConstant.imgBackground6,
                            height: getVerticalSize(
                              385.00,
                            ),
                            width: getHorizontalSize(
