...
class SenderSideItemWidget extends StatelessWidget {
  SenderSideItemWidget(this.senderSideItemModelObj);

  SenderSideItemModel senderSideItemModelObj;

  var controller = Get.find<SenderSideController>();
          ...
          children: [
            Align(
              ...
              child: CommonImageView(
                svgPath: ImageConstant.imgBackground11,
                height: getVerticalSize(
                  422.00,
                ),
                width: getHorizontalSize(
